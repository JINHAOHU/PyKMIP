    ...
    def encrypt(self,
        ...
        Returns:
            dict: The results of the encrypt operation, containing the
                ...
                'auth_tag'          | (bytes) Specifies the tag that will be
                                    | needed to authenticate the decrypted data.
                                    | Only returned on completion of the
                                    | encryption of the last of the plaintext by
                                    | an authenticated encryption cipher.
                                    | Optional, defaults to None. Added in
                                    | KMIP 1.4.
                'result_status'     | (ResultStatus) An enumeration indicating
                                    | the status of the operation result.
                'result_reason'     | (ResultReason) An enumeration providing
        ...
        if payload:
            ...
            print('auth_tag in clien is {0}'.format(payload.auth_tag))
